...
Revision ID: e80ec6db1900
Revises: 
Create Date: 2025-10-07 13:50:59.555376
...
def upgrade():
    ...
    sa.Column('leave_type', sa.String(length=2), nullable=True, comment='请假情况'),
    sa.CheckConstraint("leave_type in ('是','否')", name='check_leave_type'),
